...
test.describe('FE test', () => {
    ...
    test('full E2E purchase flow', async ({ page }) => {
         ...
         */
        await test.step('Verify inventory page and products', async () => {
         ...
         */
        let itemCount = 0
        await test.step('Add all products to cart and navigate to cart page', async () => {
            const inventory = new InventoryPage(page)
            itemCount = await inventory.addAllItems()
         ...
         */
        await test.step('Verify cart item count and continue to checkout', async () => {
         ...
         */
        await test.step('Fill personal information in checkout form', async () => {
         ...
         */
        await test.step('Validate pricing summary and finish order', async () => {
         ...
         */
        await test.step('Verify final order completion page', async () => {
